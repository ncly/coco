...
\item model requires parameters that are linked to the bank's balance sheet/strategy
\end{itemize}
...
rho This is approximately the long-run daily correlation between Treasury bill yields and the S&P 500
