...
\centering
\begin{tikzpicture}
\begin{axis}[width=11cm, height=8.8cm, axis y line*=left, ylabel={$Theoretical$ $Price$}, ymin =70,
...
\end{tikzpicture}
\caption[Comparison of pricing results for a generic CoCo]{Comparison of pricing results for a generic CoCo (only green crosses refer to right y-axis)}
