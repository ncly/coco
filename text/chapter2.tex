...
\begin{table}[H]
	...
	\begin{tabular}{p{1.5cm}p{2cm}p{2cm}p{2cm}p{2cm}p{2cm}}
		...
		\midrule
			\textbf{Write-down} & \cellcolor{red!20} n/a & \cellcolor{red!20} n/a & \cellcolor{green!20} Full by (100\% of notional) & \cellcolor{green!20} Partial (75\% of notional) & \cellcolor{green!20} Staggered (multiples of 25\% of notional) \\
			\textbf{Conversion price} & \cellcolor{green!20} Fixed at GBP 0.59 ($=S_0$) & \cellcolor{green!20}Floored at lowest of USD 20 and 30 day-VWAP & \cellcolor{red!20} n/a & \cellcolor{red!20} n/a & \cellcolor{red!20} n/a \\
